...
func (x *EchoInput) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *EchoReply) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
var file_echo_proto_rawDesc = []byte{
	...
	,
}
...
var file_echo_proto_goTypes = []interface{}{
	(*EchoInput)(nil), // 0: echo.EchoInput
	(*EchoReply)(nil), // 1: echo.EchoReply
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: echo.Echo.Echo:input_type -> echo.EchoInput
	1, // 1: echo.Echo.Echo:output_type -> echo.EchoReply
...
type EchoClient interface {
	Echo(ctx context.Context, in *EchoInput, opts ...grpc.CallOption) (*EchoReply, error)
}
...
func (c *echoClient) Echo(ctx context.Context, in *EchoInput, opts ...grpc.CallOption) (*EchoReply, error) {
	out := new(EchoReply)
...
type EchoServer interface {
	Echo(context.Context, *EchoInput) (*EchoReply, error)
}
...
func (*UnimplementedEchoServer) Echo(context.Context, *EchoInput) (*EchoReply, error) {
...
func _Echo_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServer).Echo(ctx, req.(*EchoInput))
	}
